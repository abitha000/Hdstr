...
class Telegram:
    ...
    BOT_TOKEN = str(env.get("BOT_TOKEN", '7641854793:AAHbAzpBITFgHijjwOUOyeX9wdEitXjPGUc'))
...
class Server:
    ...
    URL = "https://web-tjsrlkx0c4go.up-de-fra1-k8s-1.apps.run-on-seenode.com/".format(
